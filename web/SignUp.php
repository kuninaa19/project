...
<link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/bootstrap/4.3.1/css/bootstrap.min.css">
  ...
  <link href="style.css?afer" rel="stylesheet" type="text/css" />
</head>
    <body>
    <br>
    <script>
...
function placeOrder(form) { //form 제출
    ...
    <div class="container">
        ...
        <form method="post" name= "sign_up" action="SignUp_ok.php">
            <fieldset>   
        <b class="txt_sign">아이디</b><br /><input type="text" class="info-form" name="id" onblur="validateId(this.value)"><p>
        <span class="error_box" id="idSpan"></span> <br/><p>
        <b class="txt_sign">비밀번호</b><br /><input type="password" class="info-form" name="pw" onblur="validatePassword(this.value)"><p>
        <span class="error_box" id="passwordSpan"></span><br/><p>
        <b class="txt_sign">비밀번호 재확인</b><br /><input type="password" class="info-form" name="pwcf" onblur="validatePassword2(this.value, pw.value)"><p>
        <span class="error_box" id="password2Span"></span><br/><p>
        <b class="txt_sign">이메일주소</b><br /><input type="text" class="info-form" name="email" onblur="validateEmail(this.value)"><p>
        <span class="error_box" id="emailSpan"></span><br/><p>
        <b class="txt_sign">닉네임</b><br /><input type="text" class="info-form" name="nickname" onblur="validateNickname(this.value)"><p>
        <span class="error_box" id="nameSpan"></span><br/><p>
