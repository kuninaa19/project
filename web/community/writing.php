<?php
    ...
    $board_name = "topic"; //이것은 게시판들의 중복을 막기위한 값입니다. (게시판 이름)
    ...
    mysqli_query($conn,"UPDATE topic SET viewed=viewed+1 where id=$number");
...
<!-- 댓글 바 -->
  ...
  <div style="display: inline-block" id="replyNum2"><?php $Count?></div></div>
    <div class="nav-right-items"></div>
