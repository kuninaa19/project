...
<head>
  ...
  <link href="style.css?efee" rel="stylesheet" type="text/css" />
  <style>
  ...
  <a class="carousel-control-next" href="#demo" data-slide="next">
    ...
    <div class="nav_sub" style="margin-top:20px">
            <div class="big-category"><a href="review/review_list.php?page=1&list=10"> 최근리뷰</a></div> 
    </div>
    <p>
    ...
    <!-- 리뷰 뿌리기 4개씩 -->
      ...
      <?php
          ...
          if($row['video']!=""){
            ...
            if($url!=""){
              ...
              echo  "<div class='imgDiv'><a href='review/writing_rv.php?id=".$row['id']."'><img src='http://img.youtube.com/vi/$id/maxresdefault.jpg' width='100%' height='100%'></div>";
            }
          }
          else{
            ...
            echo  "<div class='imgDiv'><a href='review/writing_rv.php?id=".$row['id']."'><img src=".$imgAddress."width='100%' height='100%'></div>";
          ...
          if($row['sumnail']!=""){
            ...
            echo  "<div class='imgDiv'><a href='review/writing_ubx.php?id=".$row['id']."'><img src=".$imgAddress."width='100%' height='100%'></div>";
          }
          else if($row['video']!=""){
            $url = $row['video']; 
            if($url!=""){
              ...
              echo  "<div class='imgDiv'><a href='review/writing_ubx.php?id=".$row['id']."'><img src='http://img.youtube.com/vi/$id/maxresdefault.jpg' width='100%' height='100%'></div>";
            }
          }
          else{
      ...
      <div class="minibox">
        <!-- 커뮤니티 리스트 출력 -->
          ...
          <!-- while문을통한 링크출력 -->
            ...
            <li class="index"><a href="community/writing.php?id=<?=$row['id']?>"><?=$row['title']?></li>
      ...
      <div class="minibox">
          ...
          if($pageTotal>$linePerPage){
            ...
            <li class="index"><a href="notice/writing.php?id=<?=$row['id']?>"><?=$row['title']?></li>
