...
<form action="update_unboxing_ok.php" name="Wform" method="post"  accept-charset="utf-8">
<table class="table table-bordered">
    <thead>
    </thead>         
        <tr>
          <th>제목</th>
          <td><input type="text" placeholder="제목을 입력해 주세요." name="subject" id="subject" class="form-control" value="<?=$row['title']?>"/></td>
        </tr>
        <tr>
          <th>내용</th>
          <td>
          ...
          <tr>
          <th>동영상</th>
          <td><input type="text" placeholder="제목을 입력해 주세요." name="video" id="video" class="form-control" value="<?=$row['video']?>"/></td>
        </tr>
    </tbody> 
</table>
<hr/>
