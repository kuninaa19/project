...
<head>
        ...
        <link href="../css/style.css?aftee" rel="stylesheet" type="text/css"/>
</head>
<body>
<br>
    <div class="container">
    ...
    <div class="nav_sub">
            <div class="big-category"> <a href="unboxing.php?page=1&list=10">언박싱</div></a>
      ...
      <div class="nav_sub">
            <div class="big-category"><a href="review_list.php?page=1&list=10"> 리뷰</div></a>
            <div class="nav-right-items"></div>
        </div>
        <div class ="flex-item" style="margin-top:30px; margin-bottom:20px;">
        <?php
