...
<div class="container">
    ...
    <div class="nav_sub">
        <div class="big-category"><a href="unboxing/unboxing.php?page=1&list=10">언박싱</div>
        </a>
        ...
        while ($row = mysqli_fetch_array($result)) {
            ...
            <div class="imgBoxDiv" style="margin-left:30px;">
                ...
                if ($row['sumnail'] != "") {
                    ...
                    echo "<div class='imgDiv'><a href='unboxing/boardPage.php?id=". $row['id']. "'><img src=" . $imgAddress . "width='100%' height='100%'></div>";
                } else if ($row['video'] != "") {
                    $url = $row['video'];
                    if ($url != "") {
                        ...
                        echo "<div class='imgDiv'><a href='unboxing/boardPage.php?id=" . $row['id'] . "'><img src='http://img.youtube.com/vi/$id/maxresdefault.jpg' width='100%' height='100%'></div>";
                    }
                } else {
                    echo "<div class='imgDiv'><a href='unboxing/boardPage.php?id=".$row['id'] ."'><img src=" . $row['sumnail'] . "width='100%' height='100%'></div>";
                }
                ?>
    ...
    <div class="nav_sub">
        <div class="big-category"><a href="review/review.php?page=1&list=10"> 리뷰</div>
        </a>
        <div class="nav-right-items"></div>
    </div>
    <div class="flex-item" style="margin-top:30px; margin-bottom:20px;">
            ...
            <div class="imgBoxDiv" style="margin-left:30px;">
                ...
                if ($row['video'] != "") {
                    ...
                    if ($url != "") {
                        ...
                        echo "<div class='imgDiv'><a href='review/boardPage.php?id=" . $row['id'] . "'><img src='http://img.youtube.com/vi/$id/maxresdefault.jpg' width='100%' height='100%'></div>";
                    }
                } else {
                    ...
                    $imgAddress1 = str_replace('width', '', $row['sumnail']); // width 가리기
                    $imgAddress = str_replace('height', '', $imgAddress1); //height 가리기
                    echo "<div class='imgDiv'><a href='review/boardPage.php?id=" . $row['id'] . "'><img src=" . $imgAddress . "width='100%' height='100%'></div>";
                }
                ?>
                <div class="imgDescDiv"><?= $row['title'] ?></div>
            </div>
